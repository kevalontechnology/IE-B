...
router.post('/', validate(productSchema), (req, res, next) => productController.create(req, res, next));
router.put('/:id', validate(productSchema), (req, res, next) => productController.update(req, res, next));
