...
router.post('/factories', (req, res, next) => masterController.createFactory(req, res, next));

router.get('/shipping-lines', (req, res, next) => masterController.getShippingLines(req, res, next));
router.post('/shipping-lines', (req, res, next) => masterController.createShippingLine(req, res, next));

router.get('/ports', (req, res, next) => masterController.getPorts(req, res, next));
router.post('/ports', (req, res, next) => masterController.createPort(req, res, next));
